<html>
  ...
  <!-- Table-->
    <div class="maincontainer content-center ">
    <table class="table-auto" >
    <thead class="text-sky-700 font-bold space-x-52">
      <th class="px-16 py-5">Day</th>
      <th class="px-16 py-5">Morning Slot</th>
      <th class="px-16 py-5">Evening Slot</th>
    </thead>
     <tbody class="bg-pink-50">
    <tr>
      <td class="px-16 py-3">Monday</td>
      @if 
      <td class="px-16 py-3">x</td>
      <td class="px-16 py-3">x</td>
    </tr>
     <tr>
      <td class="px-16 py-3">Tuesday</td>
      <td class="px-16 py-3">x</td>
      <td class="px-16 py-3">x</td>
    </tr>
     <tr>
      <td class="px-16 py-3">Wednesday</td>
      <td class="px-16 py-3">x</td>
      <td class="px-16 py-3">x</td>
    </tr>
     <tr>
      <td class="px-16 py-3"> Thursday</td>
      <td class="px-16 py-3">x</td>
      <td class="px-16 py-3">x</td>
    </tr>
     <tr>
      <td class="px-16 py-3">Friday</td>
      <td class="px-16 py-3">x</td>
      <td class="px-16 py-3">x</td>
    </tr>
     <tr>
      <td class="px-16 py-3">Saturday</td>
      <td class="px-16 py-3">x</td>
      <td class="px-16 py-3">x</td>
    </tr>
  </div>
